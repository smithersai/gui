    ...
    static func commandItems(developerToolsEnabled: Bool) -> [CommandPaletteItem] {
        var items: [CommandPaletteItem] = [
            ...
            CommandPaletteItem(
                ...
                subtitle: "Create a new terminal tab and make it active.",
                icon: "terminal.fill",
                section: "Commands",
                keywords: ["terminal", "shell", "tab", "tmux"],
                shortcut: "Cmd+T",
                action: .newTerminal,
                isEnabled: true
            ),
            CommandPaletteItem(
                ...
                subtitle: "Close the active chat/run/terminal tab when applicable.",
                icon: "xmark.circle",
                section: "Commands",
                keywords: ["close", "tab", "session", "terminal"],
                shortcut: "Cmd+W",
                action: .closeCurrentTab,
                isEnabled: true
            ),
            CommandPaletteItem(
                id: "command.reopen-tab",
                title: "Reopen Closed Tab",
                subtitle: "Closed-tab history is not available in this build.",
                icon: "clock.arrow.trianglehead.counterclockwise.rotate.90",
                section: "Commands",
                keywords: ["reopen", "closed", "tab"],
                shortcut: "Cmd+Shift+T",
                action: .unsupported("Reopen closed tab is not available yet."),
                isEnabled: false
            ),
            CommandPaletteItem(
                id: "command.next-tab",
                title: "Next Visible Tab",
                subtitle: "Move to the next visible tab.",
            ...
            CommandPaletteItem(
                ...
                title: "Previous Visible Tab",
                subtitle: "Move to the previous visible tab.",
            ...
            CommandPaletteItem(
                id: "command.tabs.switcher",
                title: "Open Tab Switcher",
                subtitle: "Open the launcher scoped to tabs.",
                icon: "square.on.square",
                section: "Commands",
                keywords: ["tab", "switcher", "tmux", "ctrl+b w"],
                shortcut: "Ctrl+B w",
                action: .openTabSwitcher,
                isEnabled: true
            ),
            CommandPaletteItem(
                id: "command.tabs.find",
                title: "Find Tab",
                subtitle: "Open the launcher and search for tabs.",
                icon: "magnifyingglass",
                section: "Commands",
                keywords: ["tab", "find", "tmux", "ctrl+b f"],
                shortcut: "Ctrl+B f",
                action: .findTab,
                isEnabled: true
            ),
        ...
        items.append(contentsOf: (1...9).map { index in
            CommandPaletteItem(
                id: "command.switch-tab-\(index)",
                title: "Switch to Tab \(index)",
                subtitle: "Switch to the \(index.ordinalLabel) visible sidebar tab.",
                icon: "number.square",
                section: "Commands",
