...
Zig side — `src/jni_bindings.zig` emits matching `Java_com_smithers-app_androidcore_CoreBridge_<method>`
...
1. Add a `Java_com_smithers-app_androidcore_CoreBridge_nativeFoo` export to
...
adb shell am start -n com.smithers-app.androidcore/.MainActivity
```
