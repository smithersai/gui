...
1. Built-in Smithers chat target
   - Lives inside the app chat route.
...
- App chat path: `ChatView`, `SessionStore`, and `AgentService` own built-in app chat.
...
- Prefer app-owned typed actions over raw visual automation.
