...
//
// Shared navigation/state owner for the SmithersGUI app shell. Extracted from
...
// iOS (`SmithersGUIiOS`) targets. It must not pull in AppKit (or UIKit) and
...
/// The cross-platform route vocabulary for the SmithersGUI app shell.
///
