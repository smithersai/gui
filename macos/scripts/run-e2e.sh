...
#   5. Run `xcodebuild test` for the `SmithersGUIMacOSE2ETests` scheme
...
#   E2E_SCHEME          default "SmithersGUIMacOSE2ETests"
...
E2E_SCHEME="${E2E_SCHEME:-SmithersGUIMacOSE2ETests}"
E2E_ONLY_TESTING="${E2E_ONLY_TESTING:-SmithersGUIMacOSE2ETests/SmithersGUIMacOSE2EHappyPathTests}"
