...
extension Smithers {
    ...
    class App: ObservableObject {
        ...
        private static func resolveAppDatabasePath(
            ...
            if let supportOverride = environment["SMITHERS_APP_APP_SUPPORT"], !supportOverride.isEmpty {
            ...
            let dir = base.appendingPathComponent("SmithersGUI", isDirectory: true)
            return prepareDatabasePath(at: dir.appendingPathComponent("app.sqlite"))
        }
        ...
        static func perform(action: Action) {
            ...
            case .toast, .desktopNotification:
                ...
                content.title = action.title ?? "Smithers App"
