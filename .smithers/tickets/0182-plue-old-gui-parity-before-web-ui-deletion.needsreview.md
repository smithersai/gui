...
`/Users/williamcory/plue` still contains browser and desktop GUI surfaces that are slated for deletion. Deleting them safely requires a SmithersGUI parity matrix first, because the old apps cover more than the minimal workspace terminal flow.
