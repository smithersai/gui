...
#      `SmithersGUIiOSE2ETests` scheme, threading the E2E env vars.
...
#   E2E_SCHEME          default "SmithersGUIiOSE2ETests"
...
E2E_SCHEME="${E2E_SCHEME:-SmithersGUIiOSE2ETests}"
E2E_ONLY_TESTING="${E2E_ONLY_TESTING:-SmithersGUIiOSE2ETests/SmithersGUIiOSE2EHappyPathTests}"
